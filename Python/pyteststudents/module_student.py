...
class Department:
    ...
    def __str__(self):
        return f"Группа 195: {self.title}, Начальник: Капранова Анжелика Владимировна, Количество студентов: {len(self.employees)} "
...
emp_1 = Student(1, 'Меринов Дмитрий Александрович', '27.11.2002', 1590)
emp_2 = Student(2, 'Мустафа Алибеков Магомедэминович', '17.12.2003', 1590)
